...
<body>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        ...
        Je tiens à vous exprimer ma sincère gratitude pour votre message envoyé via mon site. Votre geste est très apprécié et je souhaite vous remercier chaleureusement pour votre temps et votre intérêt! Nous allons vous répondre sous peu!
        </p>
      </div>
    </section>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Ayida - Tech</span></strong>
      </div>
      <div class="credits">
